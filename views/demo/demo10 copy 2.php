...
$radioName = 'diem_tbc'; // tên nhóm radio chung
...
<tr>
  ...
  <td class="text-center">
    <input type="radio" name="<?= $radioName ?>" value="<?= $max ?>">
  </td>
</tr>
<?php endforeach; ?>
...
<tr>
          <td>1</td>
          <td class="text-start">Tham gia nhiệt tình, đầy đủ và có ý thức các hoạt động tập trung do Nhà trường, Khoa, Đoàn Than niên, Hội Sinh viên tổ chức. <i>(Trừ 05 điểm/1 lần vắng mặt)</i></td>
          <td>10</td>
          <td>
            <select class="form-select form-select-sm">
        ...
        <tr>
          <td>2</td>
          <td class="text-start">Có ý thức và tích cực tham gia tuyên truyền công tác phòng chống tệ nạn xã hội, hoạt động công ích, tình nguyện, từ thiện, nhân đạo, công tác xã hội. </td>
          <td>05</td>
          <td>
            <select class="form-select form-select-sm">
              <?php for($i=0;$i<=5;$i++): ?><option><?=$i?></option><?php endfor;?>
...
<tr>
  ...
  <td>
    <select class="form-select form-select-sm" name="phan_loai_<?= strtolower(str_replace(' ', '_', $label)) ?>">
      <?php for($i=0; $i<=$max; $i++): ?>
  ...
  <td colspan="4">
    ...
    <span style="font-style: italic;">(Điểm tối đa 10 điểm)</span>
        ...
        <tr>
          ...
          <td>
            <select class="form-select form-select-sm">
              <?php for($i=0;$i<=0;$i++): ?><option><?=$i?></option><?php endfor;?>
            </select>
          </td>
        </tr>

<!-- STT 3 - Quy định điểm cho cán bộ lớp / Đoàn / Hội (GỘP cột Nội dung + Điểm tối đa) -->
<tr>
  <td>3</td>
      ...
      <table class="table table-bordered table-sm align-middle mb-0">
        <thead class="table-light text-center">
          <tr>
            ...
            <th style="width: 80px;">Xếp loại<br>XS</th>
        ...
        <tbody class="text-center">
          <tr>
            <td class="text-start">Cấp trưởng</td>
            <td>10</td>
            <td>9</td>
            <td>8</td>
            <td>6</td>
          ...
          <tr>
            <td class="text-start">Cấp phó</td>
            <td>8</td>
            <td>7</td>
            <td>6</td>
            <td>4</td>
  ...
  <td class="text-center">
    <input type="number" class="form-control form-control-sm text-center" placeholder="Nhập điểm" min="0" max="10">
  </td>
</tr>
