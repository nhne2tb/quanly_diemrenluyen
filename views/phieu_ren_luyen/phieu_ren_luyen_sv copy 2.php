...
<div class="container-box">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <button class="btn btn-outline-secondary btn-sm rounded-pill px-3" onclick="history.back()">
      ⬅ Quay lại
    </button>
...
<style>
  ...
  input.input-line {
    border: none;
    border-bottom: 1.5px solid #004aad;
    width: 65px;
    text-align: center;
  ...
  @media print {
    ...
    .container-box { box-shadow: none; border: none; padding: 0 0 0 25px; }
...
<div class="container-box">
  ...
  <div class="info-box">
    <div class="row">
      <div class="col-md-6">
        <div class="info-line"><strong>Họ và tên:</strong><div><?= htmlspecialchars($student['ho_ten']) ?></div></div>
<div class="info-line">
  ...
  <div>
    ...
    ?>
        ...
        <div class="info-line"><strong>Lớp:</strong><div><?= htmlspecialchars($student['lop']) ?></div></div>
        <div class="info-line"><strong>Khóa học:</strong><div><?= htmlspecialchars($student['nien_khoa'] ?? '2022 - 2026') ?></div></div>
        <div class="info-line">
          <strong>Học kỳ:</strong>
          <div>
            <select name="hoc_ky" class="input-line">
      ...
      <div class="col-md-6">
        <div class="info-line"><strong>MSSV:</strong><div><?= htmlspecialchars($student['mssv']) ?></div></div>
        <div class="info-line"><strong>Giới tính:</strong><div><?= htmlspecialchars($student['gioi_tinh']) ?></div></div>
        <div class="info-line"><strong>Khoa:</strong><div><?= htmlspecialchars($student['ma_khoa']) ?></div></div>
        <div class="info-line">
          <strong>Năm học:</strong>
          <div>
            <input type="text" name="nam_bd" class="input-line" maxlength="4" placeholder="2025"> -
            <input type="text" name="nam_kt" class="input-line" maxlength="4" placeholder="2026">
          </div>
        </div>
      </div>
    </div>
