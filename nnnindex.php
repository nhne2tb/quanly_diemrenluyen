...
$projectRoot = str_contains($host, 'localhost') ? '' : '/';
...
<header class="header">
  <div class="container">
    <img src="<?= $base_url ?>logoweb.png" alt="Logo DThU">
    <div>
...
<div class="container container-main">
  <div class="row justify-content-center">
    ...
    <div class="col-lg-7 mb-4">
      ...
      <div id="tab2" class="fade" style="display:none;">
        <div class="noti-card">
...
function showTab(tabId) {
  ...
  t1.style.display = (tabId === 'tab1') ? 'block' : 'none';
  t2.style.display = (tabId === 'tab2') ? 'block' : 'none';
